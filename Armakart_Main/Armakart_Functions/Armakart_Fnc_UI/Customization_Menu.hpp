class Customization_Menu
{
	...
	class controls
	{
		...
		{
			idc = 1000;
			onload ="uiNamespace setVariable [ 'UI_Color_1', _this select 0 ];";
		...
		{
			idc = 1000;
			onload ="uiNamespace setVariable [ 'UI_Color_2', _this select 0 ];";
		...
		{
			idc = 1000;
			onload ="uiNamespace setVariable [ 'UI_Color_3', _this select 0 ];";
		...
		{
			idc = 1610;
			action = "call NJP_Client_Fnc_UI_Color;";
		...
		{
			idc = 1601;
			action = "execVM 'Armakart_Main\Armakart_Player_Loadouts\Farmer.sqf'";
		...
		{
			idc = 1612;
			action = "execVM 'Armakart_Main\Armakart_Player_Loadouts\[LOW] Construction.sqf'";
		...
		{
			idc = 1611;
			action = "execVM 'Armakart_Main\Armakart_Player_Loadouts\[LOW] Paramedic.sqf'";
		...
		{
			idc = 1610;
			action = "execVM 'Armakart_Main\Armakart_Player_Loadouts\[LOW] Aid Worker.sqf'";
		...
		{
			idc = 1611;
			action = "execVM 'Armakart_Main\Armakart_Player_Loadouts\[LOW] IDAP.sqf'";
		...
		{
			idc = 1612;
			action = "execVM 'Armakart_Main\Armakart_Player_Loadouts\[LOW] EOD.sqf'";
		...
		{
			idc = 1610;
			action = "execVM 'Armakart_Main\Armakart_Player_Loadouts\[LOW] Mechanic.sqf'";
		...
		{
			idc = 1609;
			action = "execVM 'Armakart_Main\Armakart_Player_Loadouts\[Contact] Spetsnaz.sqf'";
		...
		{
			idc = 1608;
			action = "execVM 'Armakart_Main\Armakart_Player_Loadouts\[Contact] Nerd.sqf'";
		...
		{
			idc = 1607;
			action = "execVM 'Armakart_Main\Armakart_Player_Loadouts\[Contact] Scientist.sqf'";
		...
		{
			idc = 1609;
			action = "execVM 'Armakart_Main\Armakart_Player_Loadouts\[Contact] Looter.sqf'";
		...
		{
			idc = 1608;
			action = "execVM 'Armakart_Main\Armakart_Player_Loadouts\[Contact] LDF.sqf'";
		...
		{
			idc = 1607;
			action = "execVM 'Armakart_Main\Armakart_Player_Loadouts\[Contact] CBRN.sqf'";
		...
		{
			idc = 1606;
			action = "execVM 'Armakart_Main\Armakart_Player_Loadouts\Police.sqf'";
			...
			h = 0.033 * safezoneH;
			colorBackground[] = {-1,-1,-1,0.7};
			tooltip = "Just make sure you don't pick Racer B"; //--- ToDo: Localize;
		};
		class RscButton_1631: RscButton
		{
			idc = 1605;
			action = "execVM 'Armakart_Main\Armakart_Player_Loadouts\Nikos.sqf'";
		...
		{
			idc = 1604;
			action = "execVM 'Armakart_Main\Armakart_Player_Loadouts\Kerry.sqf'";
		...
		{
			idc = 1603;
			action = "execVM 'Armakart_Main\Armakart_Player_Loadouts\VR Guy.sqf'";
		...
		{
			idc = 1602;
			action = "execVM 'Armakart_Main\Armakart_Player_Loadouts\Racer A.sqf'";
		...
		{
			idc = 1601;
			action = "execVM 'Armakart_Main\Armakart_Player_Loadouts\Racer B.sqf'";
		...
		{
			idc = 1606;
			action = "execVM 'Armakart_Main\Armakart_Player_Loadouts\Surfer.sqf'";
		...
		{
			idc = 1605;
			action = "execVM 'Armakart_Main\Armakart_Player_Loadouts\Fisherman.sqf'";
		...
		{
			idc = 1604;
			action = "execVM 'Armakart_Main\Armakart_Player_Loadouts\Hunter.sqf'";
		...
		{
			idc = 1603;
			action = "execVM 'Armakart_Main\Armakart_Player_Loadouts\Simp.sqf'";
		...
		{
			idc = 1602;
			action = "execVM 'Armakart_Main\Armakart_Player_Loadouts\ION.sqf'";
		...
		{
			idc = 1601;
			action = "execVM 'Armakart_Main\Armakart_Player_Loadouts\Ghillie.sqf'";
		...
		{
			idc = 1601;
			action = "execVM 'Armakart_Main\Armakart_Player_Loadouts\Press.sqf'";
