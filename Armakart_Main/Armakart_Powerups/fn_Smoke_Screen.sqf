...
["Armakart", "MyKey", "Powerup Action", {
	...
	[] Spawn {
		...
		////////////////////////////////////////////////////////////////////////////////////////////////
			...
			_somevehicle = vehicle player;
			_smoke_shell_1 = selectRandom ["SmokeShellRed","SmokeShellBlue","SmokeShellOrange","SmokeShellGreen","SmokeShellYellow","SmokeShellPurple"];
			_smoke_shell_2 = selectRandom ["SmokeShellRed","SmokeShellBlue","SmokeShellOrange","SmokeShellGreen","SmokeShellYellow","SmokeShellPurple"];
			_smoke_1 = _smoke_shell_1 createVehicle position _somevehicle;
			_smoke_2 = _smoke_shell_2 createVehicle position _somevehicle;
			_smoke_3 = _smoke_shell_1 createVehicle position _somevehicle;
			_smoke_4 = _smoke_shell_2 createVehicle position _somevehicle;
			_smoke_5 = _smoke_shell_1 createVehicle position _somevehicle;
			_smoke_6 = _smoke_shell_2 createVehicle position _somevehicle;
			{_x attachto [_somevehicle,[0.5,-0.5,-0.6]];} forEach [_smoke_1,_smoke_2];
			{_x attachto [_somevehicle,[-0.5,-0.5,-0.6]];} forEach [_smoke_3,_smoke_4];
			{_x attachto [_somevehicle,[0,-0.5,-0.4]];} forEach [_smoke_5,_smoke_6];
			No_item = true;
