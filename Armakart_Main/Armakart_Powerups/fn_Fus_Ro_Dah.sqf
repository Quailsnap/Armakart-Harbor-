/*
	...
	Description:
		Fus-Ro-Dah powerup, adds a triger in front of the player and LAUNCHES whomever is in the trigger
*/
...
["Armakart", "MyKey", "Powerup Action", {
	...
	[] Spawn {
		...
		////////////////////////////////////////////////////////////////////////////////////////////////
			...
			[_Scream_obj, player] remoteexeccall ["NJP_Armakart_fnc_FusRoDah_Effect", 0];
			_trgSpc = createTrigger ["EmptyDetector", getPosATL player];
			[_trgSpc, [3.2, 12, (getDir player), true, 6]] remoteExec ["setTriggerArea", 0, true];
