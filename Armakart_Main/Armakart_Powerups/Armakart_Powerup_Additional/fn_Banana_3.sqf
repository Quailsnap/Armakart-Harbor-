...
["Armakart", "MyKey", "Powerup Action", {
	...
	[] Spawn {
		uiSleep 0.1;
		hintsilent parseText "<t>Banana 3 Status:  </t><t color='#eef441'>Dropping...</t>";
		////////////////////////////////////////////////////////////////////////////////////////////////
		...
		////////////////////////////////////////////////////////////////////////////////////////////////
		hint parseText "<t>Banana 3 Status:  </t><t color='#ff0000'>Banana Set</t>";
		playsound"hint";
		No_item = true;
	};
...
[] Spawn {
	while {Initial_hint} do {
			hintsilent parseText "<t>Banana 3 Status:  </t><t color='#45f442'>Ready To Place</t>";
			uiSleep 0.05;
	};
};
playsound"hint";
