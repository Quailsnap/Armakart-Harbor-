...
["Armakart", "MyKey", "Powerup Action", {
	...
	[] Spawn {
		uiSleep 0.1;
		hintsilent parseText "<t>Boost 2 Status:  </t><t color='#eef441'>Boosting...</t>";
		////////////////////////////////////////////////////////////////////////////////////////////////
		...
		////////////////////////////////////////////////////////////////////////////////////////////////
		hint parseText "<t>Boost 2 Status:  </t><t color='#ff0000'>Boost Complete</t>";
		[] call NJP_Armakart_fnc_Boost_3;
	};
...
[] Spawn {
	while {Initial_hint} do {
			hintsilent parseText "<t>Boost 2 Status:  </t><t color='#45f442'>Ready To Boost</t>";
			uiSleep 0.05;
	};
};
playsound"hint";
