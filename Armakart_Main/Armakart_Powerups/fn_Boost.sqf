...
["Armakart", "MyKey", "Powerup Action", {
	...
	[] Spawn {
		uiSleep 0.1;
		hintsilent parseText "<t>Boost Status:  </t><t color='#eef441'>Boosting...</t>";
		////////////////////////////////////////////////////////////////////////////////////////////////
		...
		////////////////////////////////////////////////////////////////////////////////////////////////
		hint parseText "<t>Boost Status:  </t><t color='#ff0000'>Boost Complete</t>";
		No_item = true;
	};
...
[] Spawn {
	while {Initial_hint} do {
		hintsilent parseText "<t color='#731717'>Boost acquired!</t><br/><br/><t>Boost Status:  </t><t color='#45f442'>Ready To Boost</t><br/><br/><t>The Boost powerup will simply give you a speed boost.</t><br/><br/><t>[Default Keybind: F]</t>";
		uiSleep 0.05;
	};
};
playsound"hint";