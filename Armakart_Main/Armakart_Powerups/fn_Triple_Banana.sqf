/*
	...
	Description:
		Triple Banana powerup, pushes players back with a trigger and setvelocity
*/
...
["Armakart", "MyKey", "Powerup Action", {
	...
	[] Spawn {
		uiSleep 0.1;
		hintsilent parseText "<t>Banana 1 Status:  </t><t color='#eef441'>Dropping...</t>";
		////////////////////////////////////////////////////////////////////////////////////////////////
			...
			[] call NJP_Armakart_fnc_Banana_Effect;
			...
			detach _trgSpc;
			[_trgSpc, 0.35] remoteExec ["setTriggerInterval", 0,true];

		////////////////////////////////////////////////////////////////////////////////////////////////
		hint parseText "<t>Banana 1 Status:  </t><t color='#ff0000'>Banana Set</t>";
		[] call NJP_Armakart_fnc_Banana_2;
	};
...
[] Spawn {
	while {Initial_hint} do {
		hintsilent parseText "<t color='#FFFF00'>Triple Banana acquired!</t><br/><br/><t>Banana 1 Status:  </t><t color='#45f442'>Ready To Place</t><br/><br/><t>The Triple Banana powerup will give you 3x Bananas, which you can place at your own volition.</t><br/><br/><t>[Default Keybind: F]</t>";
		uiSleep 0.05;
	};
};
playsound"hint";